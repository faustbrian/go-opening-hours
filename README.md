...
[![quality](https://github.com/faustbrian/go-opening-hours/actions/workflows/ci.yml/badge.svg?branch=main&job=quality)](https://github.com/faustbrian/go-opening-hours/actions/workflows/ci.yml)
[![lint](https://github.com/faustbrian/go-opening-hours/actions/workflows/ci.yml/badge.svg?branch=main&job=lint)](https://github.com/faustbrian/go-opening-hours/actions/workflows/ci.yml)
[![vulnerability](https://github.com/faustbrian/go-opening-hours/actions/workflows/ci.yml/badge.svg?branch=main&job=vulnerability)](https://github.com/faustbrian/go-opening-hours/actions/workflows/ci.yml)
[![NilAway advisory](https://github.com/faustbrian/go-opening-hours/actions/workflows/ci.yml/badge.svg?branch=main&job=nilaway-advisory)](https://github.com/faustbrian/go-opening-hours/actions/workflows/ci.yml)
[![PostgreSQL](https://github.com/faustbrian/go-opening-hours/actions/workflows/integration.yml/badge.svg?branch=main&job=postgres)](https://github.com/faustbrian/go-opening-hours/actions/workflows/integration.yml)
[![release](https://github.com/faustbrian/go-opening-hours/actions/workflows/release.yml/badge.svg?job=verify)](https://github.com/faustbrian/go-opening-hours/actions/workflows/release.yml)
[![publish](https://github.com/faustbrian/go-opening-hours/actions/workflows/release.yml/badge.svg?job=publish)](https://github.com/faustbrian/go-opening-hours/actions/workflows/release.yml)
...
| `openinghourscalendar` | `go-calendar` dates and holiday closures |
| `openinghourstemporal` | Lossless `go-temporal/timeofday` conversion |
