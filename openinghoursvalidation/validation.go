...
// suitable for registration with go-validation once that module is published.
...
// CodeInvalidSchedule is the stable go-validation violation code.
...
// Validator returns a deterministic go-validation adapter.
