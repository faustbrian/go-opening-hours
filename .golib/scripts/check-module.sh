...
run_gate() {
    ...
    case "${selected}" in
        ...
        licenses)
            ...
            if [[ "${module_path}" != "github.com/faustbrian/go-opening-hours" &&
                "${module_path}" != github.com/faustbrian/go-opening-hours/* ]]; then
            ...
            run_go_tool \
                ...
                go-licenses \
                check ./... \
                --ignore "github.com/faustbrian/go-opening-hours"
            ;;
        sbom)
            applicable security || { skip_not_applicable security; return; }
