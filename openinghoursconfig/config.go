...
// configuration sources while leaving environment/file ownership to go-config.
...
// Value implements go-config's value-unmarshal seam without owning sources.
...
// UnmarshalConfigValue decodes canonical JSON text supplied by go-config.
